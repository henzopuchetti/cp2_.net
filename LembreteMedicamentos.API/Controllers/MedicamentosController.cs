...
public class MedicamentosController : ControllerBase
{
    ...
    public MedicamentosController(MedicamentoService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Post(Medicamento medicamento)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Put(int id, Medicamento medicamento)
    {
        if (id != medicamento.Id) return BadRequest();
        var result = await _service.UpdateAsync(medicamento);
